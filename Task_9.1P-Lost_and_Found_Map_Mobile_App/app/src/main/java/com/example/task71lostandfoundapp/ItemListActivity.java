...
/**
 * Displays all saved adverts in a list.
 * A spinner is provided so the user can filter items by category.
 */
...
public class ItemListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerFilter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            // No action is required because "All" is loaded by default.
        });
    }
    ...
    protected void onResume() {
        ...
        // Refreshes the list when returning from Create or Detail screens.
        loadAllItems();
    }
