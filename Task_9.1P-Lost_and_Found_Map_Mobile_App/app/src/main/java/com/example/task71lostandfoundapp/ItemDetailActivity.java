...
/**
 * Shows full details of one selected advert.
 * The user can also remove the advert once the lost/found item has been resolved.
 */
...
public class ItemDetailActivity extends AppCompatActivity {
    ...
    // Deletes the advert from SQLite and returns to the previous screen.
