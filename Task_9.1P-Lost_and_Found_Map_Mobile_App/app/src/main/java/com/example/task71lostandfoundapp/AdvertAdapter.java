...
/**
 * Custom adapter used by the ListView in ItemListActivity.
 * Converts each Advert object into one visible row in the item list.
 */
public class AdvertAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Reuses existing row view where possible to improve ListView performance.
        if (convertView == null) {
        ...
        // Loads the saved image URI from the device.
        imgItem.setImageURI(Uri.parse(advert.getImageUri()));

        // Opens full detail screen for the selected advert.
